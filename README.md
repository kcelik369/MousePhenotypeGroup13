...
- originals/ stores the original metadata files provided to the group; this includes the SOP which dictates the valid range of values for the data stored in data/, as well as a number of related information to be converted into tables.
